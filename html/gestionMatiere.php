...
<div id="nav-bar">
  ...
  <div id="nav-header"><a id="nav-title" href="Menu_Principal.php" target="_blank">C<i class="fab fa-codepen"></i>DEPEN</a>
  ...
  <div id="nav-footer">
    ...
    <div id="nav-footer-content">
      <Lorem>Bienvenue dans notre projet stock</Lorem>
    </div>
  </div>
</div>
<!-- partial -->
